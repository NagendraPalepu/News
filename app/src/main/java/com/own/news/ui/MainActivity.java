    ...
    public class ChannelsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            MyViewHolder (View view) {
                ...
                int width = AppUtils.getCalculatedWidth (MainActivity.this, 100);


                GridLayoutManager.LayoutParams grLayoutParams = (GridLayoutManager.LayoutParams) layout.getLayoutParams ();
                grLayoutParams.width = (width - (3 * AppUtils.getCalculatedWidth (MainActivity.this, 1))) / 2;
                grLayoutParams.height = (width - (3 * AppUtils.getCalculatedWidth (MainActivity.this, 1))) / 2;
                grLayoutParams.setMargins (AppUtils.getCalculatedWidth (MainActivity.this, 1), 0, AppUtils.getCalculatedWidth (MainActivity.this, 1), 0);
        ...
        public void onBindViewHolder (@NonNull final RecyclerView.ViewHolder holder, int position) {
            ...
            if (holder instanceof MyViewHolder) {
                ...
                if (channels != null) {
                    ImageUtils.loadImage (channels.getImageUrl (), ((MyViewHolder) holder).thumbnail, ImageUtils.getRequestOptions (R.drawable.ic_launcher_background));
